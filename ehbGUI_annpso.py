...
def ValWindow(param,label,failure):
    ...
    if failure=='':
        messagebox.showerror('Calculation Error', 'Error: Calculation is requierd first!')
        plt.close()
...
def Ilustration(failure):
    ...
    newWindow.title('Failure Illustration')
    newWindow.geometry("652x320")
    ...
    canvas = tk.Canvas(newWindow, width = 365, height = 320, bg='white')  
    ...
    #Failurelabel=ttk.Label(newWindow, anchor='w', font='Helvetica 10 bold')
    #Failurelabel.place(relx=0.63, rely=0.05, relwidth=.4,relheight=text_height)
    #Description_label=ttk.Label(newWindow, anchor='w')
    #Description_label.place(relx=0.63, rely=0.13, relwidth=.4)
    ...
    #Description_label['text']=failure_description 
    #Failurelabel['text']=failure_detail 
    
    
    text = scrolledtext.ScrolledText(newWindow, width=36, height=19.4, wrap = tk.WORD, font = ("Helvetica", 10)) 
...
diam_scale = tk.Scale(labelframe1, from_=16, to=20, variable=concr_value, orient = 'horizontal',  command=getValue, resolution=4, showvalue='off', troughcolor='white', sliderlength=12, sliderrelief='flat',activebackground='#007AD9',highlightthickness=0, bg='#deddd9',borderwidth=.5)
diam_scale.set(16.0)
diam_scale.place(relx=frame1_rewidth+.08, rely=0.03+respacing, relwidth=entry_width-.02)#, relheight=.06)

diam_vlabel=tk.Label(labelframe1, text='16.0', anchor='w', bg='white')
diam_vlabel.place(relx=frame1_rewidth-.04, rely=0.02+respacing)#, relwidth=entry_width/3.5
...
bg_scale = tk.Scale(labelframe1, from_=8.8, to=10.9, variable=concr_value, orient = 'horizontal',  command=getValue, resolution=2, showvalue='off', troughcolor='white', sliderlength=12, sliderrelief='flat',activebackground='#007AD9',highlightthickness=0, bg='#deddd9',borderwidth=.5)
bg_scale.set(8.8)
bg_scale.place(relx=frame1_rewidth+.08, rely=0.02+2*respacing, relwidth=entry_width-.02)#, relheight=.06)

bg_vlabel=tk.Label(labelframe1, text='8.8', anchor='w', bg='white')
bg_vlabel.place(relx=frame1_rewidth-.04, rely=0.02+2*respacing)#, relwidth=entry_width/3.5
...
sha_scale = ttk.Scale(labelframe1, from_=150, to=190, variable=concr_value, orient = 'horizontal',  command=getValue)
sha_scale.set(170.0)
...
sha_vlabel.place(relx=frame1_rewidth-.04, rely=0.02+3*respacing)#, relwidth=entry_width/3.5
...
gaug_scale = ttk.Scale(labelframe1, from_=80, to=180, variable=concr_value, orient = 'horizontal',  command=getValue)
...
gaug_vlabel.place(relx=frame1_rewidth-.04, rely=0.02+4*respacing)#, relwidth=entry_width/3.5
...
concr_scale = ttk.Scale(labelframe1, from_=20, to=80, variable=concr_value, orient = 'horizontal',  command=getValue)
...
concr_vlabel.place(relx=frame1_rewidth-.04, rely=0.02+5*respacing)#, relwidth=entry_width/3.5
...
slend_scale = ttk.Scale(labelframe1, from_=18.8, to=47.6, variable=concr_value, orient = 'horizontal',  command=getValue)
...
slend_vlabel.place(relx=frame1_rewidth-.04, rely=0.02+6*respacing)#, relwidth=entry_width/3.5
...
#button=ttk.Button(root, text='Read parameters', style="Accentbutton", command=lambda: [graph(thick_entry.get(), sha_entry.get(),gaug_entry.get(), diam_entry.get()),slender_func(thick_entry.get())])
#button.place(relx=.26, rely=.89, relwidth=.2, relheight=text_height)
